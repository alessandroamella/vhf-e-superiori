...
export class EdiToAdifConverter {
  ...
  private static readonly BANDS: Record<string, string> = {
    "50 MHz": "6m",
    "70 MHz": "4m",
    "144 MHz": "2m",
    "432 MHz": "70cm",
  ...
  private static readonly FREQUENCIES: Record<string, string> = {
    "50 MHz": "50",
    "70 MHz": "70",
    "144 MHz": "144",
    "432 MHz": "432",
  ...
  private static readonly TX_MODES: Record<string, string> = {
    "0": "NON",
    "1": "SSB",
    "2": "CW",
    "3": "CW",
  ...
  public static convert(
    ...
    const {
      programId = "M1GEO+DH5YM EDI-ADIF Converter",
      programVersion = "Version 2 TS",
      adifVersion = "3.1",
    } = options;
   ...
   */
  public static async convertFromFile(
    filePath: string,
    options: ConversionOptions = {},
