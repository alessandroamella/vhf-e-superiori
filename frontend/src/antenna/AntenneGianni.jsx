        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 p-6 rounded">
            <p className="text-lg font-semibold text-center text-gray-700 dark:text-gray-200 italic">
              NEL VIVO RICORDO DI UN AMICO CHE HA DEDICATO LA VITA CON PASSIONE
              ALLA PROGETTAZIONE DI ANTENNE YAGI, CERTI DI FARE LA SUA VOLONTÀ,
              CONDIVIDIAMO CON TUTTI I SUOI PROGETTI
            </p>
          </div>
        </div>
