        ...
        <Layout>
            ...
            >
                <form onSubmit={fetchDeleteJoinRequest}>
                    <Modal.Header>
                        Annullamento richiesta di partecipazione
                    </Modal.Header>
                    <Modal.Body>
                        ...
                        <div className="flex flex-col gap-4">
                            <p className="text-base leading-relaxed -mb-2">
                                Sei sicuro di annullare la tua richiesta di
                                partecipazione a:
                            </p>
                            <Link
                            ...
                            {deleteJoinRequest?.isApproved && (
                                <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                    ...
                                    <strong>
                                        se la annulli, dovrai fare una nuova
                                        richiesta se intenderai partecipare
                                    </strong>
                                </p>
                            )}
                            <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    ...
                    <div>
                        ...
                        {user && (
                            <>
                                ...
                                >
                                    <div
                                        className={isEditing ? "block" : "flex"}
                                    >
                                        <div className="mb-2 block">
                                            <Label
                                                htmlFor="name"
                                    ...
                                    <small className="mt-4">
                                        Se hai sbagliato a inserire il
                                        nominativo o desideri eliminare il tuo
                                        account, per favore procedi a inviarci
                                        una mail ad{" "}
                                        <a
                        ...
                        {joinRequests && events ? (
                            joinRequests.length > 0 ? (
                                        ...
                                        {isAfter(
                                            ...
                                            <div>
                                                <Button
                                                    color="warning"
                                                    onClick={() =>
                                                        setDeleteJoinRequest(j)
                                                    }
                                                    disabled={
                                                        deleteJoinRequestDisabled
                                                    }
                                                >
                                                    Annulla richiesta
                                                </Button>
                                ...
                                <Alert color="info">
                                    ...
                                    <p>
                                        Ma puoi richiedere di partecipare a uno
                                        dei nostri flash mob sfogliando gli
                                        eventi visibili in{" "}
